...
namespace ISL.Firefly.DataTypes.Common.Attributes
{
    ...
    {
        const string AttributeName = "MaxValue";
        ...
        public MaxValueAttribute(double maximumValue)
        {
        ...
        {
            object attrObj = prop.GetCustomAttributes(typeof(MaxValueAttribute), true).FirstOrDefault();
        ...
        private static bool IsAttributeValid(
            ...
            MaxValueAttribute minValueAttr,
            ...
            string ancestorPropertyNames)
        {
            ...
            switch(type)
            {
                ...
                case "Decimal":
                    ...
                    {
                        valid = (iConvertibleValue.ToDouble(null) <= minValueAttr.MaximumValue);
                    }
                    else
                    {
                        // Castible instead?
                        valid = ((double)attrInstanceValue <= minValueAttr.MaximumValue);
                    }
                    break;
                default:
